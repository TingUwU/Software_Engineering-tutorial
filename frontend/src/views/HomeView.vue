        ...
        <section class="category-section">
            ...
            <div class="slider-container">
                ...
                <div ref="chineseSlider" class="slider">
                    <div v-for="shop in chineseShops" :key="shop.id" class="shop-card" @click="handleShopClick(shop)">
        ...
        <section class="category-section">
            ...
            <div class="slider-container">
                ...
                <div ref="westernSlider" class="slider">
                    <div v-for="shop in westernShops" :key="shop.id" class="shop-card" @click="handleShopClick(shop)">
                        <img :src="shop.menu[0]?.imgUrl || require('@/assets/logo.png')" class="shop-img" alt="店家圖片">
                        <p class="shop-name">{{ shop.name }}</p>
                    </div>
                </div>
